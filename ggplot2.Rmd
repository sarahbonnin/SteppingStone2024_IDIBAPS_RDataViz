...
All are functions that take one parameter **n** i.e. the number of colors needed.
...
This exercise aims to get you some practice on some of the fine-tuning we have just used.
...
2. Facet the plot depending on the **color**.
