...
Function [**ggMarginal**](https://www.rdocumentation.org/packages/ggExtra/versions/0.10.1/topics/ggMarginal) from package {ggExtra} allows to easily add histograms, boxplots or density plots to a scatter plot.
...
The **mapping of variables** (for example, using **color** or **fill**) can also be inherited to the marginal plots.
...
Adding more features that we have seen so far (we will see more of "theme" later!):
